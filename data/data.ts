...
const groups = [
    ...
    {
        id: 7,
        name: "KKU Knowledge Center",
        topic: "แอพพลิเคชันเกี่ยวกับการศึกษา/สรุปเนื้อหาความรู้ที่ตรงตามที่เรียน ของนศ.มหาวิทยาลัยขอนแก่น",
        Target: "นักศึกษาที่ต้องการสรุปเนื้อหาการเรียนเพื่อนำไปใช้ในการทบทวนและในการสอบ",
        details: [
            "แอปสรุปพวกเนื้อหา สรุปเรื่องอะไรก็ได้ที่เรียน",
            "คนที่มาสรุปก็เป็นอาจารย์หรือนศ.ก็ได้",
            "มีตัวกรองที่กรองเฉพาะของคณะ/สาขา",
            "มีช่องคุยเล่นแยกซึ่งก็มีห้องแชทแยกแต่ละคณะ/สาขา และคณะอื่นสามารถเข้ามาคุยได้",
            "ไม่มีการแบ่งแยกชั้นปี"
        ],
        username:"g07",
        key:"akouvkjnofai"
    },
