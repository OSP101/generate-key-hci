            ...
            <div className=" text-[#333]">
                <div className="min-h-screen flex flex-col items-center justify-center">
                    {/* <div className={`grid md:grid-cols-2 items-center gap-4 max-w-6xl w-full bg-gray-500 p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md `}> */}
                        <Card className='grid md:grid-cols-2 items-center gap-4 max-w-6xl w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md'>
                        <div className="md:max-w-md w-full sm:px-6 py-4">
                            <form action="">
                                <div className={`${emailInvalid ? `mb-0` : `mb-12`}`}>
                                    <h3 className="text-3xl font-extrabold">Log in</h3>
                                    <p className={`text-sm mt-4`}>Don't have an account <Link href="/" className="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</Link></p>
                                </div>

                                <div role="alert" className={`alert alert-warning ${emailInvalid ? `mt-3 mb-3` : `hidden`}`}>
                                ...
                                <div>
                                    ...
                                    <div className="relative flex items-center">
                                        <input name="email" type="email" required onChange={handleInputChange} className="w-full text-sm border-b border-gray-300 focus:border-[#333] px-2 py-3 outline-none" placeholder="Enter email" />
                                ...
                                <div className="mt-8">
                                    ...
                                    <div className="relative flex items-center">
                                        <input name="password" type={passwordType ? `password` : `text`} required onChange={handleInputChange} className="w-full text-sm border-b border-gray-300 focus:border-[#333] px-2 py-3 outline-none" placeholder="Enter password" />
                                ...
                                <div className="flex items-center justify-between gap-2 mt-5">
                                    ...
                                    <div>
                                        <Link href="jajvascript:void(0);" className="text-blue-600 font-semibold text-sm hover:underline">
                                            Forgot Password?
                                        </Link>
                                    </div>
                                </div>
                                ...
                                <div className="space-x-8 flex justify-center">
                                    <button type="button"
                                        className="border-none outline-none" onClick={handleGoogleSignin}>
